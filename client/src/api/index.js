...
export const deletePlaylist = (id) => api.post(`/deleteplaylist/${id}`)
export const addSong = (body) => api.post('/addsong', body)
export const deleteSong = (body) => api.post('/deletesong', body)
